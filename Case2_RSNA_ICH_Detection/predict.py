...
def evaluate_main(data_dir, model_name, num_classes, batch_size, load_model_path):
    ...
    dataloader = torch.utils.data.DataLoader(
        image_dataset, batch_size=batch_size, num_workers=4, shuffle=False
    )
    # use GPU
    ...
    df = pd.DataFrame(columns = ['Prediction'], data = np.array(preds))
    df.to_csv('Prediction.csv', index = False)


if __name__ == "__main__":
    #   to the ImageFolder structure
    data_dir = "/Users/chenboyu/Desktop/NCTU_Degital_Medicine/Case2_RSNA_ICH_Detection/TestingData_png"
    ...
    load_model_path = "/Users/chenboyu/Desktop/NCTU_Degital_Medicine/Case2_RSNA_ICH_Detection/log/resnet50_004.model"
